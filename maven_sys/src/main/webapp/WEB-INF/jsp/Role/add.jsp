    ...
    <form action="" class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6" >
				  ...
				  <!--此处写权限的列表   -->
                <c:forEach var="PList" items="${allPermissionList}">
                    <input id="subject2" type="checkbox" name="permissionId" value="${PList.id}" /><label for="subject2" style="margin-right: 10px;">${PList.description}</label>
                </c:forEach>
            </div>
        </div>
        ...
        <div class="row cl">
            <div class="col-9 col-offset-2">           	
                <input class="btn btn-primary radius" type="button" value="添加"  onclick="roleAdd()"/>
