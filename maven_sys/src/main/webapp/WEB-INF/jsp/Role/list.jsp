    ...
    <table class="table table-border table-bordered table-bg table-hover">
        <thead>
            <tr>
                <th>角色名称</th>
                <th>描&nbsp;&nbsp;述</th>
                <th>操&nbsp;&nbsp;作&nbsp;&nbsp;&nbsp;&nbsp;<shiro:hasPermission name="role:createRole">
                    <button class="btn size-MINI btn-secondary radius" onclick="window.location='roleAdd.do'"> 添加</button>
     ...
     <c:forEach var="roles" items="${RoleList}">
                <tr>
                    ...
                    <td>                 
                        ...
                        <shiro:hasPermission name="role:updateResource">
