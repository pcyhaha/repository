    ...
    <table class="table table-border table-bordered table-bg table-hover">
        <thead>
            <tr>
                ...
                <th>状&nbsp;&nbsp;态</th>
				<th>操&nbsp;&nbsp;作&nbsp;&nbsp;&nbsp;&nbsp;
					<shiro:hasPermission name="adminUser:create">
						<button class="btn size-MINI btn-secondary radius" onclick="window.location='toadd.do'"> 添加</button>
					</shiro:hasPermission>
				</th>
            </tr>
        </thead>
        	...
        	<c:forEach var="adminUserList" items="${adminUserList}">
                <tr>
                    ...
                    <td>
						...
						<shiro:hasPermission name="adminUser:updatePassWord">
                        	<button class="btn size-MINI btn-secondary radius" onclick="updatePassword(${adminUserList.id})">重置密码</button>&nbsp;
						</shiro:hasPermission>

						<shiro:hasPermission name="adminUser:updateAdminUserRole">
                        	<button class="btn size-MINI btn-secondary radius" onclick="window.location='getAdminUserInfo.do?id=${adminUserList.id}'">分配角色</button>&nbsp;
						</shiro:hasPermission>

						<shiro:hasPermission name="adminUser:updateDisabled">
